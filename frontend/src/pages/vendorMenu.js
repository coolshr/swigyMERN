...
export default function FoodMenu() {
  ...
  async function st() {
    ...
    let tempFood = await axios.get(`http://localhost:5000/food/vendorMenu`, {
      headers: {
  ...
  async function handleSubmit(e) {
    ...
    console.log(toSend)
    let resp = await fetch("http://localhost:5000/food/update", {
      method: "POST",
      headers: {
    ...
    // let resp = await fetch("http://localhost:5000/food/", {
    //   method: "POST",
    //   headers: {
    //     'Content-Type': 'application/json',
    //     'x-auth-token': toekn,
